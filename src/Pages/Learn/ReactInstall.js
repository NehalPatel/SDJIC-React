const ReactInstall = () => {
    return (
        <>
            ...
            <p className="text-dark">Use following command to create new application</p>
            <code>
                npx create-react-app sdjic
            </code>
            <p className="text-dark">create-react-app will create an application <mark>sdjic</mark> and few folder/files.</p>
            <hr />
